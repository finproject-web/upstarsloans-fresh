          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Loan Amount ({currentLoanConfig.amounts})
              </label>
            ...
            <div>
              ...
              <input
                ...
                placeholder={`${currentLoanConfig.title} - ${currentLoanConfig.description}`}
                required
                readOnly
              />
            </div>
  ...
  const renderAgreementStep = () => (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Review and Sign Your {currentLoanConfig.title} Agreement</h2>
        <p className="text-gray-600">Please review your personalized {currentLoanConfig.title} agreement and sign to proceed</p>
      </div>

      <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
        {/* Agreement Content */}
        <div className="bg-gray-50 rounded-lg p-6 mb-8 max-h-96 overflow-y-auto">
          <h3 className="text-xl font-bold text-gray-900 mb-4">{currentLoanConfig.title} AGREEMENT - UpStars Loans</h3>
          ...
          <div className="space-y-4 text-sm text-gray-700">
            ...
            <div className="border-t pt-4">
              ...
              <div className="space-y-1 ml-4">
                ...
                <div><strong>Loan Type:</strong> {currentLoanConfig.title}</div>
                <div><strong>Available Amounts:</strong> {currentLoanConfig.amounts}</div>
                <div><strong>Terms:</strong> {currentLoanConfig.terms}</div>
        ...
        <div className="border-t pt-6">
          ...
          <div className="mt-6">
            <label className="flex items-start space-x-3">
              ...
              />
              <span className="text-sm text-gray-700">
                I have read, understood, and agree to all terms and conditions outlined in this {currentLoanConfig.title} agreement. I understand this is an electronic signature and has the same legal effect as a handwritten signature. By signing below, I confirm that this electronic signature is legally binding.
              </span>
            </label>
          </div>
        </div>
