...
const PersonalFinancing = () => {
  ...
  const handleStep1Submit = (e) => {
    ...
    if (formData.loanAmount && formData.loanPurpose && formData.firstName && formData.lastName && 
        formData.homeAddress && formData.city && formData.state && formData.zipCode && formData.dateOfBirth &&
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
            ...
            <form onSubmit={handleStep2Submit} className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">We may use this number for additional verification if needed</p>
              </div>
        ...
        <div className="border-t pt-6">
          ...
          <div className="mt-6">
            <label className="flex items-start space-x-3">
              ...
              />
              <span className="text-sm text-gray-700">
                I have read, understood, and agree to all terms and conditions outlined in this agreement. I understand this is an electronic signature and has the same legal effect as a handwritten signature.
              </span>
            </label>
          </div>
        </div>
